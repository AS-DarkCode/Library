<div class="w-full max-w-2xl mx-auto">
  <form class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-0" method="post">
    <h2 class="text-2xl font-bold mb-4">Add Notification</h2>

    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="notificationType">
        Notification Type
      </label>
      <select id="notificationType" name="notificationType" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        <option value="NewBookAdded">New Book Added</option>
        <option value="BookRequestApproved">Book Request Approved</option>
        <option value="UserRegistrationSuccessful">User Registration Successful</option>
      </select>
    </div>

    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="notificationMessage">
        Notification Message
      </label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="notificationMessage" type="text" placeholder="Enter notification message" name="notificationMessage" required>
    </div>
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Name" type="text" placeholder="Enter Name Here" name="name" required>
    </div>

    <div class="flex items-center justify-between">
      <button type="submit" class="text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2" name="save">
        <svg aria-hidden="true" class="w-6 h-5 me-2 -ms-1" viewBox="0 0 2405 2501" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_1512_1323)">
            ...
            <path d="M1495.83 1594.02L1731.43 1580.33L2009.87 2014.65L1495.83 1594.02ZM826.508 1399.47L1124.58 1861.75L758.088 1879.59L826.508 1399.47Z" fill="#F6851B" stroke="#F6851B" stroke-width="5.94955" />
            <path d="M1495.83 1594.02L1788.55 2039.64L1403.61 1699.92L1495.83 1594.02Z" fill="#E4751F" stroke="#E4751F" stroke-width="5.94955" />
  ...
  ?>
    <div class="w-full max-w-2xl mx-auto mb-5 p-5">
      <ul class="divide-y divide-gray-200">
        <li class="flex justify-between items-center py-2">
          <a href="#" class="flex-1">
            <div class="text-lg font-medium"><?php echo $key->type ?></div>
            <p class="text-gray-500"> By <?php echo $key->name; ?> <b><?php echo $key->date_time; ?></b></p>
          </a>
        </li>

<div class="flex p-2">
    <img id="imagePreview" class="w-24 h-24 mt-2 rounded-full shadow-lg" src="<?php echo 'uploads/' . $Admin_data->profile_picture; ?>" alt="Profile image" />
    ...
    <form method="POST" class="space-y-4" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="first_name" value="<?php echo $Admin_data->first_name; ?>" name="first_name" class="mt-1 p-2 w-full border rounded-md">
            </div>

            <div>
                <label for="last_name" class="block text-sm font-medium text-gray-700">Last Name</label>
                <input type="text" id="last_name" value="<?php echo $Admin_data->last_name; ?>" name="last_name" class="mt-1 p-2 w-full border rounded-md">
            </div>
        </div>

        <div>
            <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
            <input type="email" id="email" name="email" value="<?php echo $Admin_data->email; ?>" class="mt-1 p-2 w-full border rounded-md">
        </div>

        <div>
            <label for="contact_number" class="block text-sm font-medium text-gray-700">Contact Number</label>
            <input type="tel" id="contact_number" name="contact_number" value="<?php echo $Admin_data->contact_number; ?>" class="mt-1 p-2 w-full border rounded-md">
        </div>
            ...
            <div>
                ...
                <select id="gender" name="gender" class="mt-1 p-2 w-full border rounded-md">
                    ...
                    <option value="Female" <?php
                                            if ($Admin_data->gender == 'female') {
                                                echo "checked";
                                            }
                                            ?>>Female</option>
                    <option value="Other" <?php
                                            if ($Admin_data->gender == 'other') {
                                                echo "checked";
                                            }
                                            ?>>Other</option>
                </select>
        ...
        <div>
            ...
            <input type="text" id="address" name="address" value="<?php echo $Admin_data->address; ?>" class="mt-1 p-2 w-full border rounded-md">
        </div>
        ...
        <div>
            ...
            <div class="space-y-2">
                <?php $hobbies_arr = explode(',', $Admin_data->hobbies); ?>
        ...
        <div class="flex justify-center pb-10 items-center">
            <button class="bg-blue-500 hover:bg-blue-700 text-white mt-3 mb-3 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline " type="submit" name="update" id="updateButton">
                UPDATE
            </button>
        </div>

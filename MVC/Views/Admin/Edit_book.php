...
<div class="container mx-auto max-w-screen-lg px-4 py-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <form method="post" enctype="multipart/form-data">
            ...
            <div class="col-span-1 md:col-span-1">
                <div class="bg-gray-200 aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
                    ...
                    <figure class="relative max-w-sm transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0 mt-3">
                        <img class="rounded-lg" id="imagePreview" src="books/<?php echo $Admin_Book_edit->cover_image ?>" alt="Book Cover">
                    </figure>
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="multiple_files" name="input_book" type="file" value="<?php echo $Admin_Book_edit->file ?>" multiple>
        ...
        <div class="px-4 py-2 bg-gray-200 rounded-t-lg dark:bg-gray-800">
            ...
            <textarea id="comment" name="description" rows="4" class="w-full px-0 text-sm text-gray-900 bg-gray-50 border-0 dark:bg-gray-800 focus:ring-0 dark:text-gray dark:placeholder-gray-400" placeholder="Book Description ..."  required><?php echo $Admin_Book_edit->description ?></textarea>
        </div>
